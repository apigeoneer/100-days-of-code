...
Started with the Login fragment, created its xml layout (well, not fully). Brushed up JavaScript.
...
**Today's Progress:** Worked more with LiveData. I should be done with the 'guess it' app tonight.
